...
class Alpha_Bar_Chart_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Chart Layout', 'alpha-core' ),
			)
		);
			$this->add_control(
				'type',
			...
			// 		'default' => esc_html__( 'Bar Chart', 'alpha-core' ),
			// 	)
			// );
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Set labels of data axis. Write multiple labels separated by comma(,). Example: Jan, Feb, Mar', 'alpha-core' ),
			...
			$this->add_control(
				'data_value_range',
				array(
					'label'       => esc_html__( 'Data Axis Range', 'alpha-core' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'description'  => esc_html__( 'Apply animate whenever chart enters in viewport', 'alpha-core' ),
					'type'         => Controls_Manager::SWITCHER,
					'default'      => 'true',
					'return_value' => 'true',
				)
