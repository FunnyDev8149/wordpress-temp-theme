...
class Alpha_Flipbox_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'alpha-elementor-widget-icon eicon-flip-box';
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Front Side Content', 'alpha-core' ),
			)
		);
			...
			$this->add_control(
				...
				array(
					'label'   => esc_html__( 'Button text', 'alpha-core' ),
					'type'    => Controls_Manager::TEXT,
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Back Side Content', 'alpha-core' ),
			)
		);
			...
			$this->start_controls_tabs( 'layout_style_tabs' );
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						array(
							'label'     => esc_html__( 'Content Alignment', 'alpha-core' ),
							'type'      => Controls_Manager::SELECT,
							'default'   => 'center',
							'options'   => array(
								'flex-start' => esc_html__( 'Top', 'alpha-core' ),
								'center'     => esc_html__( 'Center', 'alpha-core' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'View More Button', 'alpha-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
	...
	protected function render() {
		...
		require ALPHA_CORE_FRAMEWORK_PATH . '/widgets/flipbox/render-flipbox-elementor.php';
	}
