...
$html .= '<div class="timeline-item timeline-item-top ' . $extra_class . '">' . $top . '</div>';
$html .= '<div class="timeline-item timeline-item-middle ' . $extra_class . '">' . $line . $point . '</div>';
$html .= '<div class="timeline-item timeline-item-bottom ' . $extra_class . '">' . $bottom . '</div>';
