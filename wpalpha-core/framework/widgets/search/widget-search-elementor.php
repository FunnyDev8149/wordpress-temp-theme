...
class Alpha_Search_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'alpha-elementor-widget-icon eicon-search';
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'label_off' => esc_html__( 'Dark', 'alpha-core' ),
					'label_on'  => esc_html__( 'Light', 'alpha-core' ),
					'default'   => 'yes',
					'condition' => array(
						'type'        => 'toggle',
						'toggle_type' => 'fullscreen',
					),
				)
			);
		...
		$this->add_control(
			'search_height',
			array(
				'label'      => esc_html__( 'Search Height', 'alpha-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', 'rem', '%' ),
				'selectors'  => array(
					'.elementor-element-{{ID}} .search-wrapper form input.form-control, .elementor-element-{{ID}} .search-wrapper .btn-search' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; border-style: solid;',
				),
				'condition'  => array(
					'type'        => 'toggle',
					'toggle_type' => 'dropdown',
		...
		if ( function_exists( 'alpha_search_form' ) ) {
			alpha_search_form(
				array(
					...
					'fullscreen_skin'  => 'yes' == $settings['fullscreen_skin'] ? 'light' : 'dark',
