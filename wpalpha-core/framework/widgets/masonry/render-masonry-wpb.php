...
// Preprocess
$wrapper_attrs = array(
	'class' => 'alpha-masonry-container ' . $atts['shortcode_class'] . $atts['style_class'],
);
...
$alpha_wpb_creative_layout = array(
...
if ( vc_is_inline() ) {
	$wrapper_attr_html .= 'data-creative-preset=' . json_encode( $alpha_wpb_creative_layout['preset'] );
...
alpha_creative_layout_style(
	...
	$alpha_wpb_creative_layout['layout'],
...
<?php
echo alpha_escaped( $content_escaped );
