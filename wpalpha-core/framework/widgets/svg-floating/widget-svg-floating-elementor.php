...
class Alpha_Svg_Floating_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'alpha-elementor-widget-icon eicon-divider-shape';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			// 	array(
			// 		'description' => sprintf( esc_html__( '%1$s%2$sNote:%3$s This floating element is only for %2$sSVG%3$s files. And SVG file should have only %2$sPath%3$s elements.%4$s', 'alpha-core' ), '<span class="important-note">', '<b>', '</b>', '</span>' ),
