		...
		$this->start_controls_section(
			...
			$ds_repeater->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Set label of dataset to be displayed in Polar area', 'alpha-core' ),
				)
			);
		...
		$this->start_controls_section(
			...
			$repeater->add_control(
				...
				array(
					...
					'type'        => Controls_Manager::TEXT,
					'description' => esc_html__( 'Set label of each radar chart', 'alpha-core' ),
				)
			);
			$repeater->add_control(
				'data',
			...
			$repeater->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Set background color of each data in Polar area.', 'alpha-core' ),
				)
			);
			$repeater->add_control(
				'chart_border_width',
