...
Free Updates',
					...
					array(
						'name'          => esc_html( 'Standard Plan', 'alpha-core' ),
						'price_value'   => '49.99',
						'currency'      => '$',
						'best_option'   => 'yes',
						'features_list' => esc_html__(
...
Free Updates',
					...
					array(
						'name'          => esc_html( 'Professional Plan', 'alpha-core' ),
						'price_value'   => '89.99',
						'currency'      => '$',
						'features_list' => esc_html__(
							'Basic Product
...
Free Updates',
	...
	protected function render() {
		...
		require ALPHA_CORE_FRAMEWORK_PATH . '/widgets/price-tables/render-price-tables-elementor.php';
	}
