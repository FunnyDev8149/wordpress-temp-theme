...
$wrapper_attrs = array(
	'class' => 'alpha-wpb-singleproducts-container ' . $atts['shortcode_class'] . $atts['style_class'],
);
...
if ( 'singleproducts' == $atts['shortcode'] ) {
	...
	if ( ! empty( $alpha_products_single_items ) ) {
		$alpha_products_single_items[ count( $alpha_products_single_items ) - 1 ]['sp_class'] = $wrapper_attrs['class'];
	}
}
