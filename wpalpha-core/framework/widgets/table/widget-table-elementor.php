...
class Alpha_Table_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'alpha-elementor-widget-icon eicon-table';
	}
	...
	protected function _register_controls() {
				...
				$tbl_header_repeater->start_controls_tab(
					...
					$tbl_header_repeater->add_control(
						...
						array(
							...
							'default'     => '',
							'description' => esc_html__( 'Show icon before or after text in the cell of table header', 'alpha-core' ),
						)
					);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					'label'     => '<b>' . esc_html__( 'Icon', 'alpha-core' ) . '</b>',
