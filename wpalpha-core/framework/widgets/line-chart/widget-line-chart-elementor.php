		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Input multiple labels separated by comman(,)', 'alpha-core' ),
				)
			);
			$this->add_control(
				'data_axis_range',
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'type'        => Controls_Manager::SELECT,
					'description' => esc_html__( 'Set border type of chart, Smooth, Non-Smooth and Stepped', 'alpha-core' ),
					'default'     => 'smooth',
					'options'     => array(
						'smooth'     => esc_html__( 'Smooth', 'alpha-core' ),
						'non_smooth' => esc_html__( 'Non Smooth', 'alpha-core' ),
						// 'stepped'    => esc_html__( 'Stepped', 'alpha-core' ),
					),
				)
			);
			$this->add_control(
