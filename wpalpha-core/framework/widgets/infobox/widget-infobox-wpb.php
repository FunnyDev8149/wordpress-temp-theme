...
$params = array(
	esc_html__( 'General', 'alpha-core' ) => array(
		array(
			...
			'param_name' => 'icon',
			'std'        => ALPHA_ICON_PREFIX . '-icon-truck',
		),
		array(
			'type'        => 'checkbox',
			'param_name'  => 'enable_svg',
			'heading'     => esc_html__( 'Enable SVG', 'alpha-core' ),
			'value'       => array( esc_html__( 'Yes', 'alpha-core' ) => 'yes' ),
			'description' => esc_html__( 'Enable to display SVG.', 'alpha-core' ),
		),
		array(
			'type'        => 'textarea_raw_html',
			'heading'     => esc_html__( 'SVG HTML', 'alpha-core' ),
			'param_name'  => 'svg_html',
			'placeholder' => esc_html__( 'Your SVG Html...', 'alpha-core' ),
			'description' => esc_html__( 'Enter your SVG Html here.', 'alpha-core' ),
			'dependency'  => array(
				'element' => 'enable_svg',
				'value'   => array(
					'yes',
		...
		array(
			...
			'param_name'  => 'title',
			'value'       => esc_html__( 'Free Shipping & Return', 'alpha-core' ),
			'admin_label' => true,
		),
		array(
			'type'        => 'textarea',
			'heading'     => esc_html__( 'Description', 'alpha-core' ),
			'param_name'  => 'description',
			'value'       => esc_html__( 'Free shipping on orders over $99', 'alpha-core' ),
			'admin_label' => true,
		),
		array(
			'type'       => 'vc_link',
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_html__( 'Title HTML Tag', 'alpha-core' ),
			'param_name' => 'html_tag',
			'value'      => array(
				'H1' => 'h1',
				'H2' => 'h2',
	...
	esc_html__( 'Style', 'alpha-core' )   => array(
		...
		esc_html__( 'Content', 'alpha-core' ) => array(
			array(
				'type'       => 'alpha_number',
				'heading'    => esc_html__( 'Title Spacing', 'alpha-core' ),
			...
			array(
				'type'       => 'alpha_number',
				'heading'    => esc_html__( 'Description Spacing', 'alpha-core' ),
			...
			array(
				'type'       => 'alpha_typography',
				'heading'    => esc_html__( 'Description Typography', 'alpha-core' ),
			...
			array(
				'type'       => 'colorpicker',
				'heading'    => esc_html__( 'Description Color', 'alpha-core' ),
...
vc_map(
	array(
		'name'            => esc_html__( 'InfoBox', 'alpha-core' ),
		'base'            => 'wpb_' . ALPHA_NAME . '_infobox',
		'icon'            => 'alpha-icon alpha-icon-infobox',
		'class'           => 'alpha_infobox',
		'content_element' => true,
		'controls'        => 'full',
		'category'        => ALPHA_DISPLAY_NAME,
		'description'     => esc_html__( 'Create alpha infobox.', 'alpha-core' ),
		'params'          => $params,
	)
);

if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_Alpha_Infobox extends WPBakeryShortCode {
	}
}
