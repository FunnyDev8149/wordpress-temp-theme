...
class Alpha_Brands_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'alpha-elementor-widget-icon eicon-photo-library';
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_brands',
			array(
				'label' => esc_html__( 'Brands Selector', 'alpha-core' ),
			)
		);
			...
			$this->add_control(
				...
				array(
					...
					'label'       => esc_html__( 'Brands Count', 'alpha-core' ),
					'description' => esc_html__( '0 value will show all brands.', 'alpha-core' ),
				)
			);
		...
		$this->start_controls_section(
			'section_brand_type',
			array(
				'label' => esc_html__( 'Brands Type', 'alpha-core' ),
			)
		);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'style_brand_name',
				array(
					'label' => esc_html__( 'Brand Name', 'alpha-core' ),
