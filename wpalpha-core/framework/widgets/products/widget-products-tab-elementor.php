...
class Alpha_Products_Tab_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Products Tab', 'alpha-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Products Tab', 'alpha-core' ),
			)
		);
			...
			$this->add_control(
				...
				array(
					...
					'default'       => array(
						array(
							'tab_title' => esc_html__( 'New Arrivals', 'alpha-core' ),
							'count'     => array(
								'unit' => 'px',
								'size' => 6,
							),
						...
						array(
							'tab_title' => esc_html__( 'Best Seller', 'alpha-core' ),
							'count'     => array(
								'unit' => 'px',
								'size' => 6,
							),
						...
						array(
							'tab_title' => esc_html__( 'Most Popular', 'alpha-core' ),
							'count'     => array(
								'unit' => 'px',
								'size' => 6,
							),
						...
						array(
							'tab_title' => esc_html__( 'Featured', 'alpha-core' ),
							'count'     => array(
								'unit' => 'px',
								'size' => 6,
							),
