...
vc_map(
	array(
		'name'            => ALPHA_DISPLAY_NAME . esc_html__( ' Video Player', 'alpha-core' ),
		'base'            => 'wpb_' . ALPHA_NAME . '_videoplayer',
		'icon'            => 'alpha-icon',
		'class'           => 'alpha_videoplayer',
		'content_element' => true,
		'controls'        => 'full',
		'category'        => ALPHA_DISPLAY_NAME,
		'description'     => esc_html__( 'Create alpha video player.', 'alpha-core' ),
		'as_child'        => array( 'only' => 'wpb_' . ALPHA_NAME . '_banner_layer' ),
		'params'          => $params,
	)
);

if ( class_exists( 'WPBakeryShortCode' ) ) {
	eval( 'class WPBakeryShortCode_WPB_' . ucfirst( ALPHA_NAME ) . '_Videoplayer extends WPBakeryShortCode {}' );
}
