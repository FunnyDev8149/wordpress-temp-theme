...
if ( 0 == count( $vendors ) ) {
	echo esc_html__( 'There are no vendors matched', 'alpha-core' );
}
		...
		if ( 'vendor-1' == $vendor_type ) { ?>
			<div class="vendor-widget vendor-widget-1">
				...
				<div class="vendor-details">
					...
					<div class="vendor-personal">
						...
						<span class="vendor-products-count">(<?php echo $vendor_info['products_count'] . esc_html__( ' Products', 'alpha-core' ); ?>)</span>
						<?php endif; ?>
			...
			<div class="vendor-widget vendor-widget-3 vendor-widget-banner">
				...
				<div class="vendor-details">
					...
					<?php if ( $visible['product_count'] ) : ?>
					<p class="vendor-products-count"><?php echo $vendor_info['products_count'] . esc_html__( ' Products', 'alpha-core' ); ?> </p>
					<?php endif; ?>
