...
if ( ! class_exists( 'Alpha_Comments_Pagination' ) ) {
	...
	class Alpha_Comments_Pagination extends Alpha_Base {
		...
		public function enqueue_scripts() {
			wp_enqueue_script( 'alpha-comments-pagination', alpha_core_framework_uri( '/addons/comments-pagination/comments-pagination' . ALPHA_JS_SUFFIX ), array( 'alpha-theme' ), ALPHA_CORE_VERSION, true );
		}
