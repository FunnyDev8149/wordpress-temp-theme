	...
	class Alpha_Product_Image_Comment extends Alpha_Base {
		...
		public function add_customize_fields( $fields ) {
			...
			$fields['product_review_image_size']  = array(
				...
				'tooltip' => sprintf( esc_html__( 'Set the value in megabytes. Currently your server allows you to upload files up to %s.', 'alpha-core' ), size_format( wp_max_upload_size() ) ), //phpcs:ignore
				'choices' => array(
					'min' => 0,
		...
		public function enqueue_scripts() {
			wp_enqueue_script( 'alpha-product-image-comments', alpha_core_framework_uri( '/addons/product-image-comments/product-image-comments' . ALPHA_JS_SUFFIX ), array( 'alpha-theme' ), ALPHA_CORE_VERSION, true );
			wp_localize_script(
