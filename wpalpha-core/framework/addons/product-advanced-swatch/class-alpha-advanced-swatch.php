	...
	class Alpha_Advanced_Swatch extends Alpha_Base {
		...
		public function add_customize_fields( $fields ) {
			...
			$fields['cs_shop_advanced_swatch_desc']        = array(
				...
				'default' => '<p class="options-custom-description option-feature-description"><img class="description-image" src="' . ALPHA_ASSETS . '/images/admin/customizer/image-attribute.jpg' . '" alt="Theme Option Descrpition Image"></p>',
			);
		...
		public function enqueue_scripts() {
			wp_enqueue_script( 'alpha-advanced-swatch', alpha_core_framework_uri( '/addons/product-advanced-swatch/swatch' . ALPHA_JS_SUFFIX ), array( 'alpha-theme' ), ALPHA_VERSION, true );
		}
