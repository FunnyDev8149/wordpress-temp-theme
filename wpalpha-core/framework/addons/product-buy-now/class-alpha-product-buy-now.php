...
if ( ! class_exists( 'Alpha_Product_Buy_Now' ) ) {
	...
	class Alpha_Product_Buy_Now extends Alpha_Base {
		...
		public function add_buy_now_btn() {
			...
			echo '<button class="single_buy_now_button button btn btn-outline btn-primary btn-rounded">' . esc_html( alpha_get_option( 'buy_now_text' ) ) . '</button>';
		}
		...
		public function enqueue_script() {
			wp_enqueue_script( 'alpha-product-buy-now', alpha_core_framework_uri( '/addons/product-buy-now/product-buy-now' . ALPHA_JS_SUFFIX ), array( 'alpha-theme' ), ALPHA_CORE_VERSION, true );
		}
