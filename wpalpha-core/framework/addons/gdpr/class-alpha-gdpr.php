	...
	class Alpha_GDPR extends Alpha_Base {
		...
		public function __construct() {
			...
			if ( function_exists( 'alpha_set_default_option' ) ) {
				...
				alpha_set_default_option( 'cookie_text', sprintf( esc_html__( 'We are using cookies to improve your experience on our website. By browsing this website, you agree to our %1$sPrivacy Policy%2$s.', 'alpha-core' ), '<a href="#">', '</a>' ) );
				alpha_set_default_option( 'cookie_version', 1 );
				alpha_set_default_option( 'cookie_agree_btn', esc_html__( 'I Agree', 'alpha-core' ) );
				alpha_set_default_option( 'cookie_decline_btn', esc_html__( 'Decline', 'alpha-core' ) );
			...
			add_filter(
				...
				function( $sections ) {
					$sections['cookie_law_info'] = array(
						'title'    => esc_html__( 'Privacy Consent Setting (GDPR)', 'alpha-core' ),
						'panel'    => 'advanced',
						'priority' => 100,
					);
					return $sections;
		...
		public function add_customize_fields( $fields ) {
			...
			$fields['choose_cookie_page']  = array(
				'section'         => 'cookie_law_info',
				'label'           => esc_html__( 'Choose Privacy Policy Page', 'alpha-core' ),
				'tooltip'         => esc_html__( 'Choose the page that will contain your privacy policy', 'alpha-core' ),
				'type'            => 'select',
			...
			$fields['cookie_decline_btn']  = array(
				'section'         => 'cookie_law_info',
				'label'           => esc_html__( 'Privacy Declinature Button Label', 'alpha-core' ),
				'type'            => 'text',
				'active_callback' => array(
					array(
						'setting'  => 'show_cookie_info',
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_script( 'alpha-gdpr', alpha_core_framework_uri( '/addons/gdpr/gdpr' . ALPHA_JS_SUFFIX ), array( 'alpha-theme' ), ALPHA_VERSION, true );
		}
