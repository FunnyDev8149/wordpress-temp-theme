...
<script type="text/template" id="alpha_studio_blocks_wrapper_template">
	<div class="blocks-wrapper closed">
		<button title="<?php esc_attr_e( 'Close (Esc)', 'alpha-core' ); ?>" type="button" class="mfp-close">&times;</button>
		<div class="category-list">
			<?php /* translators: %s represents theme name.*/ ?>
			<h3><img src="<?php echo ALPHA_CORE_URI; ?>/assets/images/logo-studio.png" alt="<?php printf( esc_attr__( '%s Studio', 'alpha-core' ), ALPHA_DISPLAY_NAME ); ?>" width="206" height="73" /></h3>
			<ul>
				...
				<li class="category-has-children">
					<a href="#" class="block-category-blocks" data-filter-by="blocks" data-total-page="<?php echo (int) $args['blocks_pages']; ?>">
						...
						<?php esc_html_e( 'Blocks', 'alpha-core' ); ?><i class="fa fa-chevron-down"></i>
					</a>
					<ul>
						<?php
			...
			<div class="blocks-section-inner">
				<div class="blocks-row">
					<div class="blocks-title">
						<h3><?php esc_html_e( 'All in One Library', 'alpha-core' ); ?></h3>
						<p><?php esc_html_e( 'Choose any type of template from our library.', 'alpha-core' ); ?></p>
					</div>
					<div class="demo-filter">
						...
						$filters  = $instance->alpha_demo_types();
						?>
						<div class="custom-select">
							<select class="filter-select">
								<option value=""><?php esc_html_e( 'Select Demo', 'alpha-core' ); ?></option>
						...
						<button class="btn btn-primary" disabled="disabled"><?php esc_html_e( 'Filter', 'alpha-core' ); ?></button>
					</div>
				</div>
					<?php if ( ! $is_ajax ) : ?>
					<div class="block-categories">
						<a href="#" class="block-category" data-category="blocks">
							<h4><?php esc_html_e( 'Blocks', 'alpha-core' ); ?></h4>
