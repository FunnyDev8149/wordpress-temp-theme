...
class Alpha_Product_Brand {
	...
	public function add_customize_fields( $fields ) {
		...
		$fields['cs_brand_about_desc']  = array(
			'section' => 'brand',
			'type'    => 'custom',
			'label'   => esc_html__( 'Please add brand taxnomy for products. You can show and filter products by brands.', 'alpha-core' ),
	...
	public function add_brand_columns_products_page( $columns ) {
		...
		$show_columns['thumb'] = '<span class="wc-image tips" data-tip="' . esc_attr__( 'Image', 'alpha-core' ) . '">' . esc_html__( 'Image', 'alpha-core' ) . '</span>';
		$show_columns['name']  = esc_html__( 'Name', 'alpha-core' );

		if ( wc_product_sku_enabled() ) {
			$show_columns['sku'] = esc_html__( 'SKU', 'alpha-core' );
		}

		if ( 'yes' === get_option( 'woocommerce_manage_stock' ) ) {
			$show_columns['is_in_stock'] = esc_html__( 'Stock', 'alpha-core' );
		}

		$show_columns['price']         = esc_html__( 'Price', 'alpha-core' );
		$show_columns['product_cat']   = esc_html__( 'Categories', 'alpha-core' );
		$show_columns['product_brand'] = esc_html__( 'Brands', 'alpha-core' );
		$show_columns['product_tag']   = esc_html__( 'Tags', 'alpha-core' );
		$show_columns['featured']      = '<span class="wc-featured parent-tips" data-tip="' . esc_attr__( 'Featured', 'alpha-core' ) . '">' . esc_html__( 'Featured', 'alpha-core' ) . '</span>';
		$show_columns['date']          = esc_html__( 'Date', 'alpha-core' );
