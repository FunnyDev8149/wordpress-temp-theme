...
class Alpha_Single_Product_Cart_Form_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Cart Form', 'alpha-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'sp_sticky',
				array(
					'label' => esc_html__( 'Add To Cart Sticky', 'alpha-core' ),
			...
			$this->start_controls_tabs( 'sp_btn_style_tabs' );
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						'sp_btn_transition',
						array(
							'label'     => esc_html__( 'Transition Duration', 'alpha-core' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'sp_qty_transition',
				array(
					'label'     => esc_html__( 'Focus Transition Duration', 'alpha-core' ),
					'type'      => Controls_Manager::SLIDER,
					'default'   => array(
						'size' => 0.2,
					),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Variations', 'alpha-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
			...
			$this->add_control(
				...
				array(
					'label'     => esc_html__( 'List field', 'alpha-core' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				)
			);
