...
if ( $minicompare ) {
	...
	<div class="compare-dropdown-box dropdown-box">
		...
		<?php if ( empty( $prod_ids ) ) : ?>
			<p class="empty-msg"><?php esc_html_e( 'No products in compare list.', 'alpha-core' ); ?></p>
		<?php else : ?>
			...
			<p class="compare-buttons buttons">
				<a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'compare' ) ) ); ?>" class="button btn btn-dark btn-rounded btn-md btn-block"><?php esc_html_e( 'Go To Compare List', 'alpha-core' ); ?></a>
			</p>
		<?php endif; ?>
