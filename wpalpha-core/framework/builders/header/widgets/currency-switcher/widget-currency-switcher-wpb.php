...
vc_map(
	array(
		'name'            => esc_html__( 'Currency Switcher', 'alpha-core' ),
		'base'            => 'wpb_' . ALPHA_NAME . '_hb_currency_switcher',
		'icon'            => 'alpha-icon alpha-icon-currency',
		'class'           => 'alpha_hb_currency_switcher',
		'content_element' => true,
		'controls'        => 'full',
		'category'        => ALPHA_DISPLAY_NAME . esc_html__( ' Header', 'alpha-core' ),
		'description'     => esc_html__( 'Create alpha currency switcher.', 'alpha-core' ),
		'params'          => $params,
	)
);

if ( class_exists( 'WPBakeryShortCode' ) ) {
	eval( 'class WPBakeryShortCode_WPB_' . ucfirst( ALPHA_NAME ) . '_HB_Currency_Switcher extends WPBakeryShortCode {}' );
}
