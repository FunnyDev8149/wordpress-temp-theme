		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'description' => sprintf( esc_html__( 'You can customize to show menu on mobile in %1$sCustomize Panel/Menus/Mobile Menu%2$s', 'alpha-core' ), '<a href="' . wp_customize_url() . '#mobile_menu" data-target="mobile_menu" data-type="section" target="_blank">', '</a>.' ),
				)
			);
