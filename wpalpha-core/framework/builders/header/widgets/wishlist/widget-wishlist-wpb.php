...
$params = array(
	esc_html__( 'General', 'alpha-core' )        => array(
		array(
			...
			'heading'    => esc_html__( 'Wishlist Type', 'alpha-core' ),
			'param_name' => 'type',
			'std'        => 'inline',
			'value'      => array(
				'block'  => array(
		...
		array(
			'type'        => 'alpha_button_group',
			'heading'     => esc_html__( 'Mini Wish List', 'alpha-core' ),
			'param_name'  => 'miniwishlist',
			'description' => esc_html__( 'Choose where to display mini wish list', 'alpha-core' ),
			'std'         => '',
			'value'       => array(
				''          => array(
		...
		array(
			...
			'param_name' => 'label',
			'std'        => esc_html__( 'Wishlist', 'alpha-core' ),
			'dependency' => array(
				'element' => 'show_label',
				'value'   => 'yes',
			),
		...
		array(
			...
			'std'        => ALPHA_ICON_PREFIX . '-icon-heart',
		),
	),
	esc_html__( 'Wishlist Style', 'alpha-core' ) => array(
		array(
	...
	esc_html__( 'Wishlist Badge', 'alpha-core' ) => array(
		array(
			'type'       => 'alpha_number',
...
vc_map(
	array(
		'name'            => esc_html__( 'Wishlist', 'alpha-core' ),
		'base'            => 'wpb_' . ALPHA_NAME . '_hb_wishlist',
		'icon'            => 'alpha-icon alpha-icon-wishlist',
		'class'           => 'alpha_hb_wishlist',
		'content_element' => true,
		'controls'        => 'full',
		'category'        => ALPHA_DISPLAY_NAME . esc_html__( ' Header', 'alpha-core' ),
		'description'     => esc_html__( 'Create alpha wishlist.', 'alpha-core' ),
		'params'          => $params,
	)
);

if ( class_exists( 'WPBakeryShortCode' ) ) {
	eval( 'class WPBakeryShortCode_WPB_' . ucfirst( ALPHA_NAME ) . '_HB_Wishlist extends WPBakeryShortCode {}' );
}
