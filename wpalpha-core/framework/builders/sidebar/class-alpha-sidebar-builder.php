...
class Alpha_Sidebar_Builder extends Alpha_Base {
	...
	public function add_admin_menus() {
		// Menu - alpha / sidebar
		add_submenu_page( 'alpha', esc_html__( 'Sidebars', 'alpha-core' ), esc_html__( 'Sidebars', 'alpha-core' ), 'administrator', 'alpha_sidebar', array( Alpha_Sidebar_Builder::get_instance(), 'sidebar_view' ) );
	}
	...
	public function sidebar_view() {
		if ( class_exists( 'Alpha_Admin_Panel' ) ) {
			...
			?>
			<button id="add_widget_area" class="alpha-sidebar-action button button-dark button-large"><?php esc_html_e( 'Add New Sidebar', 'alpha-core' ); ?></button>
