<?php
/**
 * Alpha Elementor Single Post Content Widget
 *
 * @author     FunnyWP
...
class Alpha_Single_Content_Elementor_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return ALPHA_NAME . '_single_content';
	}

	public function get_title() {
		return esc_html__( 'Post Content', 'alpha-core' );
	}

	public function get_icon() {
		return 'alpha-elementor-widget-icon eicon-post-content';
	}
	...
	public function get_keywords() {
		return array( 'single', 'custom', 'layout', 'post', 'content' );
	}
