<?php
/**
 * Alpha Elementor Single Post Share Widget
 *
 * @author     FunnyWP
...
class Alpha_Single_Share_Elementor_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return ALPHA_NAME . '_single_share';
	}

	public function get_title() {
		return esc_html__( 'Post Share', 'alpha-core' );
	}
	...
	public function get_keywords() {
		return array( 'single', 'custom', 'layout', 'post', 'share' );
	}
