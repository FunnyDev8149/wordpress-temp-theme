					...
					$repeater->add_control(
						...
						array(
							...
							'options'   => apply_filters(
								...
								array(
									''          => esc_html__( 'Default', 'alpha-core' ),
									'product-1' => esc_html__( 'Type 1', 'alpha-core' ),
									'product-2' => esc_html__( 'Type 2', 'alpha-core' ),
									'product-3' => esc_html__( 'Type 3', 'alpha-core' ),
									'product-4' => esc_html__( 'Type 4', 'alpha-core' ),
									'product-5' => esc_html__( 'Type 5', 'alpha-core' ),
									'product-6' => esc_html__( 'Type 6', 'alpha-core' ),
									'product-7' => esc_html__( 'Type 7', 'alpha-core' ),
									'product-8' => esc_html__( 'Type 8', 'alpha-core' ),
