...
function alpha_elementor_tab_layout_controls( $self, $condition_key = '' ) {
	...
	$self->add_control(
		...
		array_merge(
			array(
				'label'   => esc_html__( 'Tab Layout', 'alpha-core' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => array(
					''         => esc_html__( 'Horizontal', 'alpha-core' ),
	...
	$self->add_responsive_control(
		...
		array_merge(
			array(
				'label'      => esc_html__( 'Vertical Nav width', 'alpha-core' ),
	...
	$self->add_responsive_control(
		...
		array_merge(
			array(
				'label'   => esc_html__( 'Tab Navs Position', 'alpha-core' ),
		...
		array_merge(
			array(
				...
				'options' => array(
					...
					'solid1'   => esc_html__( 'Solid 1', 'alpha-core' ),
					'solid2'   => esc_html__( 'Solid 2', 'alpha-core' ),
					'outline1' => esc_html__( 'Outline 1', 'alpha-core' ),
					'outline2' => esc_html__( 'Outline 2', 'alpha-core' ),
					'link'     => esc_html__( 'Underline', 'alpha-core' ),
				),
			),
			$condition_key ? array(
				'condition' => array(
...
function alpha_elementor_tab_style_controls( $self, $condition_key = '' ) {
	$self->start_controls_section(
		...
		array_merge(
			array(
				'label' => esc_html__( 'Tab', 'alpha-core' ),
	...
	$self->add_control(
		...
		array_merge(
			array(
				'label'      => esc_html__( 'Tab Border Radius (px)', 'alpha-core' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
					'%',
	...
	$self->add_responsive_control(
		'nav_margin',
		array(
			'label'      => esc_html__( 'Nav Box Margin', 'alpha-core' ),
	...
	$self->add_responsive_control(
		'nav_item_margin',
		array(
			'label'      => esc_html__( 'Nav Item Margin', 'alpha-core' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'separator'  => 'before',
			'size_units' => array(
				'px',
	...
	$self->add_responsive_control(
		'nav_item_padding',
		array(
			'label'      => esc_html__( 'Nav Item Padding', 'alpha-core' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'default'    => array(
				'top'    => 8,
				'right'  => 15,
	...
	$self->add_control(
		...
		array_merge_recursive(
			array(
				'label'     => esc_html__( 'Nav Border Width (px)', 'alpha-core' ),
	...
	$self->add_control(
		'bg_color_hover',
		array(
			'label'     => esc_html__( 'Hover Nav Background Color', 'alpha-core' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
				// Stronger selector to avoid section style from overwriting
	...
	$self->add_control(
		'color_hover',
		array(
			'label'     => esc_html__( 'Hover Nav Color', 'alpha-core' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
				// Stronger selector to avoid section style from overwriting
	...
	$self->add_control(
		'bg_color_active',
		array(
			'label'     => esc_html__( 'Active Nav Background Color', 'alpha-core' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
				// Stronger selector to avoid section style from overwriting
	...
	$self->add_control(
		'color_active',
		array(
			'label'     => esc_html__( 'Active Nav Color', 'alpha-core' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
				// Stronger selector to avoid section style from overwriting
