...
class Alpha_Element_Column extends Elementor\Element_Column {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'column_additional',
			array(
				'label' => ALPHA_DISPLAY_NAME . esc_html__( ' Settings', 'alpha-core' ),
			...
			$this->add_control(
				...
				array(
					...
					'options' => array(
						...
						'banner_layer'      => esc_html__( 'Banner Layer', 'alpha-core' ),
						'accordion_content' => esc_html__( 'Accordion Content', 'alpha-core' ),
						'tab_content'       => esc_html__( 'Tab Content', 'alpha-core' ),
					),
				)
			);
		...
		$this->start_controls_section(
			'column_acc',
			array(
				'label'     => esc_html__( 'Accordion Content', 'alpha-core' ),
				'tab'       => Controls_Manager::TAB_LAYOUT,
				'condition' => array(
			...
			$this->add_control(
				'accordion_title',
				array(
					'label' => esc_html__( 'Accordion Title', 'alpha-core' ),
			...
			$this->add_control(
				'accordion_heading',
				array(
					'label'     => esc_html__( 'Header Icon', 'alpha-core' ),
			...
			$this->add_group_control(
				...
				array(
					...
					'separator' => 'before',
					'label'     => esc_html__( 'Header Icon Typography', 'alpha-core' ),
			...
			$this->add_control(
				...
				array(
					'label'     => esc_html__( 'Header Icon Space', 'alpha-core' ),
					'type'      => Controls_Manager::NUMBER,
					'selectors' => array(
			...
			$this->add_responsive_control(
				...
				array(
					'label'      => esc_html__( 'Accordion Content Padding', 'alpha-core' ),
		...
		$this->start_controls_section(
			'column_tab',
			array(
				'label'     => esc_html__( 'Tab Content', 'alpha-core' ),
				'tab'       => Controls_Manager::TAB_LAYOUT,
				'condition' => array(
					'use_as' => 'tab_content',
				),
			...
			$this->add_control(
				'tab_icon',
				array(
					'label'       => esc_html__( 'Tab Icon', 'alpha-core' ),
			...
			$this->add_control(
				'tab_icon_pos',
				array(
					'label'       => esc_html__( 'Tab Icon Position', 'alpha-core' ),
					...
					'options'     => array(
						...
						'up'    => esc_html__( 'Up', 'alpha-core' ),
						'down'  => esc_html__( 'Down', 'alpha-core' ),
					),
					'condition'   => array(
						'use_as' => 'tab_content',
					),
			...
			$this->add_control(
				'tab_icon_space',
				array(
					'label'       => esc_html__( 'Tab Icon Spacing (px)', 'alpha-core' ),
					'description' => esc_html__( 'Controls spacing between icon and label in tab item header.', 'alpha-core' ),
			...
			$this->add_control(
				'tab_icon_size',
				array(
					'label'       => esc_html__( 'Tab Icon Size (px)', 'alpha-core' ),
		...
		<<?php echo $this->get_html_tag() . ' ' . $this->get_render_attribute_string( '_wrapper' ); ?>>
			...
			if ( 'accordion_content' == $settings['use_as'] ) : // accordion header
				...
				<div class="card-header">
					<a href="<?php echo $this->get_data( 'id' ); ?>" class="<?php echo 1 == $alpha_section['index'] ? 'collapse' : 'expand'; ?>">
						<?php
						if ( $settings['accordion_header_icon']['value'] ) {
							echo '<i class="' . $settings['accordion_header_icon']['value'] . '"></i>';
						}
						?>
						<span class="title"><?php echo $settings['accordion_title'] ? esc_html( $settings['accordion_title'] ) : esc_html__( 'Untitled', 'alpha-core' ); ?></span>
						<?php
						if ( $alpha_section['active_icon'] && $alpha_section['active_icon']['value'] ) {
							echo '<span class="toggle-icon opened"><i class="' . $alpha_section['active_icon']['value'] . '"></i></span>';
						}
						if ( $alpha_section['icon'] && $alpha_section['icon']['value'] ) {
							echo '<span class="toggle-icon closed"><i class="' . $alpha_section['icon']['value'] . '"></i></span>';
						}
						?>
					</a>
				</div>
