<?php
/**
 * Alpha WPBakery Number Callback
 *
 * follow below example of alpha_number control
 *
 *
 * @since 1.0
 *
...
function alpha_dropdown_callback( $settings, $value ) {
	...
	$html .= '<select class="alpha-wpb-dropdown' . ( $is_responsive ? '' : ' simple-value' ) . '" data-xl="' . ( isset( $responsive_value['xl'] ) ? esc_html( $responsive_value['xl'] ) : '' ) . '"
...
vc_add_shortcode_param( 'alpha_dropdown', 'alpha_dropdown_callback', ALPHA_CORE_PLUGINS_URI . '/wpb/params/dropdown.js' );
