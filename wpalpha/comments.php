...
<div id="comments" class="comments">
	...
	<h3 class="title title-simple"><?php comments_number( esc_html__( 'No Comments', 'alpha' ), esc_html__( 'One Comment', 'alpha' ), esc_html( _n( '% Comment', '% Comments', get_comments_number(), 'alpha' ) ) ); ?></h3>
