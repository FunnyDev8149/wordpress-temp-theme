				...
				<?php endif; ?>
					...
					<div class="store-info">
						...
						<div class="social-icons-container">
							<?php echo alpha_wcv_format_store_social_icons( $vendor_id ); ?>
						</div>
		...
		<div class="wcv-store-address-container wcv-store-grid ">
			...
			<?php if ( $verified_vendor ) : ?>
				<div class="wcv-verified-vendor">
					<span><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-check"></i> <?php echo esc_html__( 'Verified Vendor', 'alpha' ); ?></span>
				</div>
			<?php endif; ?>
		</div>
	</div>
