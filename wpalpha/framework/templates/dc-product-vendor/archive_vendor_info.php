		...
		<?php if ( 'template2' != $template_class && apply_filters( 'wcmp_vendor_store_header_show_social_links', true, $vendor->id ) ) : ?>
			<div class="wcmp_social_profile social-icons">
				...
				if ( $vendor_fb_profile ) {
					?>
				<a target="_blank" class="social-icon social-facebook stacked" href="<?php echo esc_url( $vendor_fb_profile ); ?>"><i class="fab fa-facebook-f"></i></a><?php } ?>
				<?php
				if ( $vendor_twitter_profile ) {
					?>
				<a target="_blank" class="social-icon social-twitter stacked" href="<?php echo esc_url( $vendor_twitter_profile ); ?>"><i class="fab fa-twitter"></i></a><?php } ?>
				<?php
				if ( $vendor_linkdin_profile ) {
					?>
				<a target="_blank" class="social-icon social-linkedin stacked" href="<?php echo esc_url( $vendor_linkdin_profile ); ?>"><i class="fab fa-linkedin"></i></a><?php } ?>
				<?php
				if ( $vendor_youtube ) {
					?>
				<a target="_blank" class="social-icon social-youtube stacked" href="<?php echo esc_url( $vendor_youtube ); ?>"><i class="fab fa-youtube"></i></a><?php } ?>
				<?php
				if ( $vendor_instagram ) {
					?>
				<a target="_blank" class="social-icon social-instagram stacked" href="<?php echo esc_url( $vendor_instagram ); ?>"><i class="fab fa-instagram"></i></a><?php } ?>
			...
			<div class="vendor_img_add">
				...
				<?php do_action( 'before_wcmp_vendor_information', $vendor_id ); ?>
					...
					if ( ! empty( $location ) && 'Enable' != $vendor_hide_address ) {
						?>
						<p class="wcmp_vendor_detail"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-map-marker"></i><label><?php echo esc_html( $location ); ?></label></p><?php } ?>
					<?php
					if ( ! empty( $mobile ) && 'Enable' != $vendor_hide_phone ) {
						?>
						<p class="wcmp_vendor_detail"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-call"></i><label><?php echo apply_filters( 'vendor_shop_page_contact', $mobile, $vendor_id ); ?></label></p><?php } ?>
					<?php
					if ( ! empty( $email ) && 'Enable' != $vendor_hide_email ) {
						?>
						<a href="mailto:<?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?>" class="wcmp_vendor_detail"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-envelope"></i><?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?></a><?php } ?>
					<?php
	...
	<div class="vendor_description">
		<div class="vendor_img_add">
			...
			<div class="wcmp_vendor_defail_wrap">
				...
				if ( ! empty( $location ) && 'Enable' != $vendor_hide_address ) {
					?>
					<p class="wcmp_vendor_detail"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-map-marker"></i><label><?php echo esc_html( $location ); ?></label></p>
				<?php } ?>

				<?php
				if ( ! empty( $mobile ) && 'Enable' != $vendor_hide_phone ) {
					?>
					<p class="wcmp_vendor_detail"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-call"></i><label><?php echo apply_filters( 'vendor_shop_page_contact', $mobile, $vendor_id ); ?></label></p>
				<?php } ?>
				...
				if ( ! empty( $email ) && 'Enable' != $vendor_hide_email ) {
					?>
					<a href="mailto:<?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?>" class="wcmp_vendor_detail"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-envelope"></i><?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?></a>
				<?php } ?>
	...
	<div class="vendor_description">
		<div class="vendor_img_add">
			...
			<?php do_action( 'before_wcmp_vendor_information', $vendor_id ); ?>
				...
				if ( ! empty( $location ) && 'Enable' != $vendor_hide_address ) {
					?>
					<p class="wcmp_vendor_detail"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-map-marker"></i><label><?php echo esc_html( $location ); ?></label></p><br /><?php } ?>
				<?php
				if ( ! empty( $mobile ) && 'Enable' != $vendor_hide_phone ) {
					?>
					<p class="wcmp_vendor_detail"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-call"></i><label><?php echo apply_filters( 'vendor_shop_page_contact', $mobile, $vendor_id ); ?></label></p><?php } ?>
