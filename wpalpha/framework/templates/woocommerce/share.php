	...
	<div class="social-icons">
		...
		if ( $share_facebook_enabled ) {
			...
			<a target="_blank" class="social-icon <?php echo esc_attr( $icon_class ); ?> social-facebook"
				...
				title="<?php esc_attr_e( 'Facebook', 'yith-woocommerce-wishlist' ); ?>">
				<?php echo alpha_strip_script_tags( $share_facebook_icon ? $share_facebook_icon : esc_html__( 'Facebook', 'yith-woocommerce-wishlist' ) ); ?>
			</a>
			<?php
		}
		...
		if ( $share_twitter_enabled ) {
			...
			<a target="_blank" class="social-icon <?php echo esc_attr( $icon_class ); ?> social-twitter"
				href="<?php echo esc_url( $link ? $link : '#' ); ?>"
				title="<?php esc_attr_e( 'Twitter', 'yith-woocommerce-wishlist' ); ?>">
				<?php echo alpha_strip_script_tags( $share_twitter_icon ? $share_twitter_icon : esc_html__( 'Twitter', 'yith-woocommerce-wishlist' ) ); ?>
			</a>
			<?php
		}
		...
		if ( $share_pinterest_enabled ) {
			...
			<a target="_blank" class="social-icon <?php echo esc_attr( $icon_class ); ?> social-pinterest"
				href="<?php echo esc_url( $link ? $link : '#' ); ?>"
				title="<?php esc_attr_e( 'Pinterest', 'yith-woocommerce-wishlist' ); ?>" onclick="window.open(this.href); return false;">
				<?php echo alpha_strip_script_tags( $share_pinterest_icon ? $share_pinterest_icon : esc_html__( 'Pinterest', 'yith-woocommerce-wishlist' ) ); ?>
			</a>
			<?php
		}
		...
		if ( $share_email_enabled ) {
			...
			<a class="social-icon <?php echo esc_attr( $icon_class ); ?> social-email"
				...
				<?php echo alpha_strip_script_tags( $share_email_icon ? $share_email_icon : esc_html__( 'Email', 'yith-woocommerce-wishlist' ) ); ?>
			</a>
			<?php
		}
		...
		if ( $share_whatsapp_enabled ) {
			...
			<a class="social-icon <?php echo esc_attr( $icon_class ); ?> social-whatsapp"
				...
				target="_blank" title="<?php esc_attr_e( 'WhatsApp', 'yith-woocommerce-wishlist' ); ?>">
				<?php echo alpha_strip_script_tags( $share_whatsapp_icon ? $share_whatsapp_icon : esc_html__( 'Whatsapp', 'yith-woocommerce-wishlist' ) ); ?>
			</a>
			<?php
		}
		?>
