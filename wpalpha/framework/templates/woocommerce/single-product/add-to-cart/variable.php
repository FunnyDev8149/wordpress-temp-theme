	...
	<?php else : ?>
		<div class="variations">
			<?php foreach ( $attributes as $attribute_name => $options ) : ?>
				...
				<?php
				echo end( $attribute_keys ) == $attribute_name ? alpha_strip_script_tags( apply_filters( 'woocommerce_reset_variations_link', '<div class="reset-variation-cont"><a class="reset_variations d-none" href="#">' . esc_html__( 'Clean All', 'alpha' ) . '</a></div>' ) ) : '';
				?>
			<?php endforeach; ?>
		</div>
