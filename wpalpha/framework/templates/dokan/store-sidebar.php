<?php
$vendor_style = alpha_get_option( 'vendor_style_option' );
...
if ( 'off' == dokan_get_option( 'enable_theme_store_sidebar', 'dokan_appearance', 'off' ) && 'full' != $sidebar_pos ) : ?>
	...
	<?php wp_enqueue_script( 'alpha-sticky-lib' ); ?>

	<div id="dokan-secondary" class="<?php echo esc_attr( $wrapper_cls ); ?>" role="complementary">

		<div class="sidebar-overlay"></div>
		<a class="sidebar-close" href="#"><i class="close-icon"></i></a>
		<a href="#" class="sidebar-toggle"><i class="fas fa-chevron-<?php echo 'right' == $sidebar_pos ? 'left' : 'right'; ?>"></i></a>
