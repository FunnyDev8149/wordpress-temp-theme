...
if ( $vendor_id ) {
	if ( apply_filters( 'wcfmmp_is_allow_sold_by', true, $vendor_id ) && wcfm_vendor_has_capability( $vendor_id, 'sold_by' ) ) {
		...
		$store_rating          = $WCFMmp->wcfmmp_reviews->get_vendor_review_rating( $vendor_id ) ? $WCFMmp->wcfmmp_reviews->get_vendor_review_rating( $vendor_id ) : 0;
			...
			<div class="col-lg-7 pl-lg-6 mb-4">
				<div class="vendor-user">
					...
					<div>
						...
						if ( apply_filters( 'wcfm_is_pref_vendor_reviews', true ) ) {
							echo wc_get_rating_html( $store_rating );
						}
						?>
					</div>
				</div>
				...
				<ul class="list-unstyled list sp-vendor-info">
					...
					<li class="store-email">
						<span><?php echo esc_html_e( 'Email:', 'alpha' ); ?></span>
						<span class="details">
					...
					<li class="store-phone">
						<span><?php echo esc_html_e( 'Phone:', 'alpha' ); ?></span>
						<span class="details">
				...
				<a href="<?php echo esc_url( $store_url ); ?>" class="btn btn-link btn-underline"><?php esc_html_e( 'Visit Store', 'alpha' ); ?><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-long-arrow-<?php echo is_rtl() ? 'left' : 'right'; ?>"></i></a>
			</div>
		</div>
		<?php

		if ( $wcfm_shop_description ) {
			echo '<div class="vendor-description pt-3 pb-3">' . alpha_strip_script_tags( $wcfm_shop_description ) . '</div>';
		}
