...
if ( ! class_exists( 'Alpha_Setup_Wizard' ) ) :
	...
	class Alpha_Setup_Wizard extends Alpha_Base {
		...
		public function add_admin_menu() {
			add_submenu_page( 'alpha', esc_html__( 'Setup Wizard', 'alpha' ), esc_html__( 'Setup Wizard', 'alpha' ), 'manage_options', $this->page_slug, array( $this, 'view_setup_wizard' ), 2 );
		}
		 ...
		 * @since 1.0
		 */
		public function alpha_demo_types() {
