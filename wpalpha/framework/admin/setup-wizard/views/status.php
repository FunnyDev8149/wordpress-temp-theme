...
?>
<h2><?php esc_html_e( 'System Status', 'alpha' ); ?></h2>
<p><?php esc_html_e( 'Check your current server performance.', 'alpha' ); ?></p>
...
<div class="system-status">
	<ul class="system-status">
		...
		<?php else : ?>
			...
			<li>
				<p class="info-qt"><?php esc_html_e( 'Do not worry if you are unable to update your server configuration due to hosting limit, you can use "Alternative Import" method in Demo Content import page.', 'alpha' ); ?></p>
				<?php
				printf(
...
</div><p class="alpha-admin-panel-actions">
