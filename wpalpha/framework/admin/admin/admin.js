...
( function ( wp, $ ) {
    ...
    themeAdmin.notification = ( function () {
        ...
        return {
            init: function () {
                initToggle( '.alpha-notification-toggle' );
                getNotifications( $( '.alpha-notifications' ) );
            }
        }
    } )();
    ...
    themeAdmin.initActivation = function () {
        ...
        themeAdmin.$body.on( 'click', '.alpha-active-content .submit input', function ( e ) {
            var $this = $( this ),
                $form = $this.closest( '#alpha_registration' ),
                $wrapper = $this.closest( '.alpha-active-content' ),
                data = {
