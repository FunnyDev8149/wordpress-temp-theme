...
defined( 'ABSPATH' ) || die;
?>
<h2><?php esc_html_e( 'Plugins', 'alpha' ); ?></h2>
<form method="post">
	<h3><?php esc_html_e( '1. Recommended Plugins', 'alpha' ); ?></h3>
	<?php
	$plugins = $this->_get_plugins();
	if ( count( $plugins['all'] ) ) {
		?>
		<p style="margin-bottom: 5px;">
			<?php esc_html_e( 'This will install the plugins which can acclerate your site.', 'alpha' ); ?><br>
	...
	<h3><?php esc_html_e( '2. Installed Plugins', 'alpha' ); ?></h3>
	...
	<ul class="installed-plugins">
		<li class="plugins-label">
			<label><?php echo esc_html__( 'Plugin Name', 'alpha' ); ?></label>
			<span><?php echo esc_html__( 'Action', 'alpha' ); ?></span>
		</li>
		<?php
		...
		<li>
			...
			<a href="<?php echo esc_attr( $slug ); ?>"><?php echo esc_html__( 'Deactivate', 'alpha' ); ?></a>
		</li>
			<?php
		}
		?>
		...
		<li>
			<label data-version="<?php echo esc_attr( $plugin['Version'] ); ?>"><?php echo esc_html( $plugin['Name'] ); ?></label>
			<span><?php echo esc_html__( 'Network Activate', 'alpha' ); ?></span>
		</li>
				<?php
			}
		}
	...
	<div class="form-checkbox">
		<input type="checkbox" id="share_plugins" name="allow_plugins_share" checked/><label style="font-weight: 600;"  for="share_plugins"><?php echo esc_html__( 'Share Plugins Information', 'alpha' ); ?></label>
		<p style="margin: 5px 0 0;" ><?php echo esc_html__( 'Please contribute to upgrade theme and your site to the best one! Your cooperation would be highly appreciated.', 'alpha' ); ?></p>
