                    ...
                    if ( 'buttonset' == control.type ) {
                        ...
                        if ( alpha_layout_vars.template_builder[ blockType ] ) {
                            if ( blockType == 'sidebar' ) {
                                control_html += '<a href="' + window.location.href.substr( 0, window.location.href.indexOf( 'wp-admin' ) + 8 ) + '/admin.php?page=alpha_sidebar" target="_blank" class="new-block-template">' + wp.i18n.__( 'Please create a new ', 'alpha' ) + blockType + '</a>';
                            } else {
                                control_html += '<a href="' + ( window.location.href.substr( 0, window.location.href.indexOf( 'wp-admin' ) + 8 ) + '/edit.php?post_type=' + alpha_admin_vars.theme + '_template&' + alpha_admin_vars.theme + '_template_type=' + blockType ) + '" target="_blank" class="new-block-template">' + wp.i18n.__( 'Please create a new ', 'alpha' ) + ( blockType == 'product_layout' ? wp.i18n.__( 'single product', 'alpha' ) : blockType ) + '</a>';
                            }
                        } else {
