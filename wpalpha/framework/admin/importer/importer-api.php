...
class Alpha_Importer_API {
	...
	protected $url = array(
		'changelog'               => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=theme_changelog',
		'theme_version'           => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=theme_version',
		'theme'                   => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=theme',
		'plugins_version'         => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=plugins_version',
		'plugins'                 => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=plugins',
		'demos'                   => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=demos',
		'plugin_list_add'         => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=plugin_list_add',
		'studio_blocks'           => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=studio_blocks',
		'studio_block_categories' => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=studio_categories',
		'studio_block_content'    => ALPHA_SERVER_URI . 'dummy/api/' . ALPHA_NAME . '_api?method=studio_block_content',
	);
