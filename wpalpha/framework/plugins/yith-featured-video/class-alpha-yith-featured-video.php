...
if ( ! class_exists( 'Alpha_Featured_Audio_Video' ) ) {

	/**
	 * Alpha Featured Video Audio Class
	 */
	class Alpha_Featured_Audio_Video extends Alpha_Base {
		...
		function enqueue_scripts() {
			wp_enqueue_style( 'alpha-featured-video-style', ALPHA_PLUGINS_URI . '/yith-featured-video/yith-featured-video' . ( is_rtl() ? '-rtl' : '' ) . '.min.css', array( 'alpha-theme' ), ALPHA_VERSION );
		}
...
Alpha_Featured_Audio_Video::get_instance();
