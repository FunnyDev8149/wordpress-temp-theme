...
add_filter( 'woocommerce_product_review_list_args', 'alpha_product_show_newest_reviews' );
			...
			if ( is_a( $prev_post, 'WP_Post' ) || is_a( $next_post, 'WP_Post' ) ) {
				...
				if ( is_a( $prev_post, 'WP_Post' ) ) {
					$html             .= '<li class="product-nav-prev">';
						$html         .= '<a href="' . esc_url( get_the_permalink( $prev_post->ID ) ) . '" rel="prev"><i class="' . ALPHA_ICON_PREFIX . '-icon-angle-left"></i>';
				...
				if ( is_a( $next_post, 'WP_Post' ) ) {
					$html             .= '<li class="product-nav-next">';
						$html         .= '<a href="' . esc_url( get_the_permalink( $next_post->ID ) ) . '" rel="next"><i class="' . ALPHA_ICON_PREFIX . '-icon-angle-right"></i>';
							$html     .= ' <span class="product-nav-popup">';
		...
		if ( $product->is_on_sale() ) {
			...
			if ( $date_diff ) {
				...
				<div class="product-countdown-container<?php echo esc_attr( $extra_class ); ?>">
					...
					<div class="countdown product-countdown countdown-compact" data-until="<?php echo esc_attr( $date_diff ); ?>" data-compact="true">0<?php echo esc_html__( 'days', 'alpha' ); ?>, 00 : 00 : 00</div>
				</div>
				<?php
			}
		}
 ...
 * @since 1.0
 */
if ( ! function_exists( 'alpha_product_show_newest_reviews' ) ) {
	function alpha_product_show_newest_reviews( $args ) {
...
// @start feature: fs_spt_vertical
if ( alpha_get_feature( 'fs_spt_vertical' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-single/product-single-vertical.php' );
}
// @end feature: fs_spt_vertical

// @start feature: fs_spt_horizontal
if ( alpha_get_feature( 'fs_spt_horizontal' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-single/product-single-horizontal.php' );
}
// @end feature: fs_spt_horizontal

// @start feature: fs_spt_grid
if ( alpha_get_feature( 'fs_spt_grid' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-single/product-single-grid.php' );
}
// @end feature: fs_spt_grid

// @start feature: fs_spt_masonry
if ( alpha_get_feature( 'fs_spt_masonry' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-single/product-single-masonry.php' );
}
// @end feature: fs_spt_masonry

// @start feature: fs_spt_gallery
if ( alpha_get_feature( 'fs_spt_gallery' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-single/product-single-gallery.php' );
}
// @end feature: fs_spt_gallery

// @start feature: fs_spt_sticky-info
if ( alpha_get_feature( 'fs_spt_sticky-info' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-single/product-single-sticky-info.php' );
}
// @end feature: fs_spt_sticky-info

// @start feature: fs_spt_sticky-thumbs
if ( alpha_get_feature( 'fs_spt_sticky-thumbs' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-single/product-single-sticky-thumbs.php' );
}
// @end feature: fs_spt_sticky-thumbs

// @start feature: fs_spt_sticky-both
if ( alpha_get_feature( 'fs_spt_sticky-both' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-single/product-single-sticky-both.php' );
}
// @end feature: fs_spt_sticky-both
