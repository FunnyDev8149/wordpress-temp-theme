	...
	function alpha_product_loop_media_action() {
		...
		if ( 'bottom' == alpha_wc_get_loop_prop( 'addtocart_pos' ) ) {
			if ( 'bottom' == alpha_wc_get_loop_prop( 'quickview_pos' ) ) {
				...
				if ( ! is_array( $show_info ) || in_array( 'quickview', $show_info ) ) {
					echo '<button class="btn-product-icon btn-quickview" data-product="' . $product->get_id() . '" title="' . esc_html__( 'Quick View', 'alpha' ) . '">' . esc_html__( 'Quick View', 'alpha' ) . '</button>';
				}
			} else {
			...
			if ( ! is_array( $show_info ) || in_array( 'quickview', $show_info ) ) {
				echo '<div class="product-action"><button class="btn-product btn-quickview" data-product="' . $product->get_id() . '" title="' . esc_html__( 'Quick View', 'alpha' ) . '">' . esc_html__( 'Quick View', 'alpha' ) . '</button></div>';
			}
		}
	}
}
...
if ( alpha_get_feature( 'fs_pt_1' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-1.php' );
}
// @end feature: fs_pt_1

// @start feature: fs_pt_2
if ( alpha_get_feature( 'fs_pt_2' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-2.php' );
}
// @end feature: fs_pt_2

// @start feature: fs_pt_3
if ( alpha_get_feature( 'fs_pt_3' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-3.php' );
}
// @end feature: fs_pt_3

// @start feature: fs_pt_4
if ( alpha_get_feature( 'fs_pt_4' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-4.php' );
}
// @end feature: fs_pt_4

// @start feature: fs_pt_5
if ( alpha_get_feature( 'fs_pt_5' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-5.php' );
}
// @end feature: fs_pt_5

// @start feature: fs_pt_6
if ( alpha_get_feature( 'fs_pt_6' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-6.php' );
}
// @end feature: fs_pt_6

// @start feature: fs_pt_7
if ( alpha_get_feature( 'fs_pt_7' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-7.php' );
}
// @end feature: fs_pt_7

// @start feature: fs_pt_8
if ( alpha_get_feature( 'fs_pt_8' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-8.php' );
}
// @end feature: fs_pt_8

// @start feature: fs_pt_list
if ( alpha_get_feature( 'fs_pt_list' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-list.php' );
}
// @end feature: fs_pt_list

// @start feature: fs_pt_widget
if ( alpha_get_feature( 'fs_pt_widget' ) ) {
	require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/woocommerce/product-loop/product-loop-widget.php' );
}
