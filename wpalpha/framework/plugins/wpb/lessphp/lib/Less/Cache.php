...
require_once alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/wpb/lessphp/lib/Less/Version.php' );
...
class Less_Cache {
	...
	public static function Cache( &$less_files, $parser_options = array() ) {
		...
		$file = alpha_framework_path( ALPHA_FRAMEWORK_PLUGINS . '/wpb/lessphp/lib/Less/Less.php' );
