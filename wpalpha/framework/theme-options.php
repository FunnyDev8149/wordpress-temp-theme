...
$alpha_option = array(
	...
	'navigator_items'              => array(
		...
		'color'          => array( esc_html__( 'Color & Skin', 'alpha' ), 'section' ),
		...
		'share'          => array( esc_html__( 'Share', 'alpha' ), 'section' ),
	...
	'product_related_title'        => esc_html__( 'Related Products', 'alpha' ),
	'product_upsells_title'        => esc_html__( 'You may also like&hellip', 'alpha' ),
